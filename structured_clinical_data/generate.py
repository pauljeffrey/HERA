...
# Allow `python generate.py` from this directory or `python -m structured_clinical_data.generate` from repo root.
...
def main() -> int:
    ...
    parser.add_argument("--count", type=int, default=5000, help="Records to generate (default: 5000).")
    ...
    if args.batch_id:
        ...
        if not args.wait:
            print(f"Track with: python -m structured_clinical_data.generate --batch-id {batch.id} --wait")
            return 0
